    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            currency.format((product['base_price'] as num?)?.toDouble() ?? 0),
      ...
      child: SingleChildScrollView(
        child: ResponsiveForm(
          ...
          fields: [
            ...
            AdminFormField(controller: _descEn, label: 'Description (EN)', maxLines: 2),
            AdminFormField(controller: _descAr, label: 'Description (AR)', maxLines: 2),
            AdminFormField(controller: _price,    label: 'Base Price',
                keyboardType: TextInputType.number, validator: Validators.positiveNumber,),
            AdminFormField(controller: _discount, label: 'Discount Price (optional)',
                keyboardType: TextInputType.number,),
            AdminFormField(controller: _catId, label: 'Category ID', validator: Validators.required),
          ],
        ),
      ),
    ),
